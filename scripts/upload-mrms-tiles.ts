/**
 * Upload MRMS tiles to AWS S3 and rotate old frames.
 *
 * Usage:
 ...
 * Requires S3_RADAR_BUCKET and CLOUDFRONT_RADAR_URL in .env.
 */
...
const BUCKET = S3_BUCKETS.radarTiles;
...
/** Upload a single frame's tiles to S3. */
...
/** List remote frame "directories" in S3 (top-level prefixes). */
...
/** Delete all tiles for a given frame timestamp from S3. */
...
async function main() {
  ...
  console.log('MRMS Tile Uploader → AWS S3');
  console.log('============================\n');
  ...
  const baseUrl = S3_PUBLIC_URLS.radarTiles;
  console.log('\n============================');
